...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        let jobId = this.props.match.params.id ? this.props.match.params.id : "";  // Get job ID from the URL
        let copyJobId = this.props.match.params.copyId ? this.props.match.params.copyId : "";  // Get copyJobId if available

        if (jobId || copyJobId) {
            // Define the URL based on whether we're editing or copying a job
            const url = jobId
                ? `http://localhost:51689/listing/listing/GetJobByToEdit?id=${jobId}`
                : `http://localhost:51689/listing/listing/GetJobForCopy?id=${copyJobId}`;
                        ...
                        <div className="ui grid">
                            <div className="row">
                                <div className="sixteen wide center aligned padded column">
                                    <h1>{this.state.jobData.id ? "Edit Job" : "Create Job"}</h1>
                                </div>
                            </div>
